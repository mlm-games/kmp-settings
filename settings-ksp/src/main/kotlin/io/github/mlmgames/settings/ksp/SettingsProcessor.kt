...
class SettingsProcessor(
  ...
  private val settingAnnotationFqcn = "io.github.mlmgames.settings.core.Setting"
  ...
  private fun generateSchemaForClass(
    ...
    val settingsSchema = ClassName("io.github.mlmgames.settings.core", "SettingsSchema")
    val settingMeta = ClassName("io.github.mlmgames.settings.core", "SettingMeta")
    val settingCategory = ClassName("io.github.mlmgames.settings.core", "SettingCategory")
    val settingType = ClassName("io.github.mlmgames.settings.core", "SettingType")

    val booleanField = ClassName("io.github.mlmgames.settings.core.fields", "BooleanField")
    val intField = ClassName("io.github.mlmgames.settings.core.fields", "IntField")
    val longField = ClassName("io.github.mlmgames.settings.core.fields", "LongField")
    val floatField = ClassName("io.github.mlmgames.settings.core.fields", "FloatField")
    val stringField = ClassName("io.github.mlmgames.settings.core.fields", "StringField")
        ...
        .addProperty(
          PropertySpec.builder(
            ...
            List::class.asClassName().parameterizedBy(
              ClassName("io.github.mlmgames.settings.core", "SettingField")
